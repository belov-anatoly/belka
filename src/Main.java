...
public class Main {
    ...
    {
        Derevo derevo = new Derevo(); // Конструктор создания экземпляра из класса Derevo
        Belochka belochka = new Belochka(); // Конструктор создания экземпляра из класса Belochka
        belochka.sum(derevo.growUpOreshki(15)); // Продемонстрировать работу системы с массивом из 15 орехов
    }
}
